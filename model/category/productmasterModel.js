...
ProductMaster.get_category_product_list = async function get_category_product_list(req,result) {
 ...
 // var sub_l2_category_query= "Select * from SubcategoryL2 where scl1_id=  '"+req.scl1_id+"' ";
 var product_list = "select pm.*,pl.*,faa.favid,IF(faa.favid,'1','0') as isfav,um.name as unit,br.brandname,sub1.name as sub_cat1,sub2.name as sub_cat2,cat.name as cat_name from ProductMaster pm left join Product_live pl on pl.pid=pm.pid left join UOM um on um.uomid=pm.uom left join Fav faa on faa.vpid = pl.vpid and faa.userid = '"+req.userid+"' left join Brand br on br.id=pm.brand left join SubcategoryL1 sub1 on sub1.scl1_id=pm.scl1_id left join  Category cat on cat.catid=sub1.catid left join SubcategoryL2 sub2 on sub2.scl2_id=pm.scl2_id "
...
ProductMaster.get_product_details = async function get_product_details(req,result) {
  ...
  // var sub_l2_category_query= "Select * from SubcategoryL2 where scl1_id=  '"+req.scl1_id+"' ";
  var product_detail = "select pm.*,pl.*,faa.favid,IF(faa.favid,'1','0') as isfav,um.name as unit,br.brandname,sub1.name as sub_cat1,sub2.name as sub_cat2,cat.name as cat_name from ProductMaster pm left join Product_live pl on pl.pid=pm.pid left join UOM um on um.uomid=pm.uom left join Fav faa on faa.vpid = pl.vpid and faa.userid = '"+req.userid+"' left join Brand br on br.id=pm.brand left join SubcategoryL1 sub1 on sub1.scl1_id=pm.scl1_id  left join  Category cat on cat.catid=sub1.catid left join SubcategoryL2 sub2 on sub2.scl2_id=pm.scl2_id  where  pl.vpid='"+req.vpid+"' "
...
// }
    ...
    if (get_collection[0].classification_type==1) { 
      //console.log("brand");
      product_list = "select pm.*,pl.*,l1.catid,faa.favid,IF(faa.favid,'1','0') as isfav,um.name as unit,br.brandname,l1.name as sub_cat1,sub2.name as sub_cat2,cat.name as cat_name from  ProductMaster pm left join SubcategoryL1  as l1 on l1.catid=pm.scl1_id left join Product_live pl on pl.pid=pm.pid left join Brand br on br.id=pm.brand left join UOM um on um.uomid=pm.uom left join Fav faa on faa.vpid = pl.vpid and faa.userid = '"+req.userid+"' left join  Category cat on cat.catid=l1.catid left join SubcategoryL2 sub2 on sub2.scl2_id=pm.scl2_id  where br.id = '"+get_collection[0].classification_id+"' and pl.live_status=1 ";
     
    // var productlist = await query(product_query);
    }else if(get_collection[0].classification_type==2){
       //console.log("category");
       product_list = "select pm.*,pl.*,l1.catid,faa.favid,IF(faa.favid,'1','0') as isfav,um.name as unit,br.brandname,l1.name as sub_cat1,sub2.name as sub_cat2,cat.name as cat_name from Category ca left join Cluster_Category_mapping as ccm on ccm.catid=ca.catid left join SubcategoryL1  as l1 on l1.catid=ca.catid left join Zone_l1_subcategory_mapping as zl1sub on zl1sub.master_l1_subcatid=l1.scl1_id left join ProductMaster as pm on pm.scl1_id=l1.scl1_id left join Product_live as pl on pl.pid=pm.pid left join Zone_category_mapping as zcm on zcm.master_catid=ca.catid left join Brand br on br.id=pm.brand left join UOM um on um.uomid=pm.uom left join Fav faa on faa.vpid = pl.vpid and faa.userid = '"+req.userid+"' left join  Category cat on cat.catid=l1.catid left join SubcategoryL2 sub2 on sub2.scl2_id=pm.scl2_id where zcm.active_status=1 and ccm.active_status=1  and pl.zoneid='"+get_nearby_zone[0].id+"' and pl.live_status=1 and ca.catid='"+get_collection[0].classification_id+"' ";
     
      // var productlist = await query(product_query);
    }else if(get_collection[0].classification_type==3){
      //console.log("sub-category 1");
      product_list = "Select pm.*,pl.*,faa.favid,IF(faa.favid,'1','0') as isfav,um.name as unit,br.brandname,l1.name as sub_cat1,sub2.name as sub_cat2,cat.name as cat_name from SubcategoryL1 as  l1 left join ProductMaster pm on pm.scl1_id=l1.scl1_id  left join  Product_live pl on pl.pid=pm.pid left join Category  as ca on l1.catid=ca.catid left join Zone_l1_subcategory_mapping zl1 on zl1.master_l1_subcatid =l1.scl1_id left join Brand br on br.id=pm.brand left join UOM um on um.uomid=pm.uom left join Fav faa on faa.vpid = pl.vpid and faa.userid = '"+req.userid+"' left join  Category cat on cat.catid=l1.catid left join SubcategoryL2 sub2 on sub2.scl2_id=pm.scl2_id where  pl.live_status=1 and zl1.zoneid='"+get_nearby_zone[0].id+"' and l1.scl1_id=  '"+get_collection[0].classification_id+"'  ";
     
      // var productlist = await query(product_query);
    }else if(get_collection[0].classification_type==4){
      //console.log("sub-category 2");
      product_list = "Select pm.*,pl.*,faa.favid,IF(faa.favid,'1','0') as isfav,um.name as unit,br.brandname,l1.name as sub_cat1,sub2.name as sub_cat2,cat.name as cat_name from SubcategoryL2 as  l2 left join ProductMaster pm on pm.scl2_id=l2.scl2_id  left join  Product_live pl on pl.pid=pm.pid left join Zone_l2_subcategory_mapping zl2 on zl2.master_l2_subcatid =l2.scl2_id left join SubcategoryL1 l1 on l1.scl1_id=l2.scl1_id left join Brand br on br.id=pm.brand left join UOM um on um.uomid=pm.uom left join Fav faa on faa.vpid = pl.vpid and faa.userid = '"+req.userid+"' left join  Category cat on cat.catid=l1.catid left join SubcategoryL2 sub2 on sub2.scl2_id=pm.scl2_id where l2.scl2_id='"+get_collection[0].classification_id+"'   and pl.live_status=1 and zl2.zoneid='"+get_nearby_zone[0].id+"'  ";
     
      // var productlist = await query(product_query);
    }else if(get_collection[0].classification_type==5){
      //console.log("sub-category 2");
      product_list = "Select pm.*,pl.*,faa.favid,IF(faa.favid,'1','0') as isfav,um.name as unit,br.brandname,l1.name as sub_cat1,sub2.name as sub_cat2,cat.name as cat_name from SubcategoryL1 as  l1 left join ProductMaster pm on pm.scl1_id=l1.scl1_id  left join  Product_live pl on pl.pid=pm.pid left join  Collection_mapping_product cmp  on cmp.pid=pl.pid left join Category  as ca on l1.catid=ca.catid left join Zone_l1_subcategory_mapping zl1 on zl1.master_l1_subcatid =l1.scl1_id left join Brand br on br.id=pm.brand left join UOM um on um.uomid=pm.uom left join Fav faa on faa.vpid = pl.vpid and faa.userid = '"+req.userid+"' left join  Category cat on cat.catid=l1.catid left join SubcategoryL2 sub2 on sub2.scl2_id=pm.scl2_id where  pl.live_status=1 and zl1.zoneid='"+get_nearby_zone[0].id+"'  and cmp.cid='"+get_collection[0].cid+"' and cmp.active_status=1 ";
...
ProductMaster.get_collection_brand_list = async function get_collection_brand_list(req,result) {
  ...
  var query1 = "";
  if (req.scl1_id !=0) {
     query1 = "and  pm.scl1_id='"+req.scl1_id+"'   group by br.id ";
  }else{
  ...
  if(get_collection[0].classification_type==1){ 
    ...
    var brand_list_query = "select br.id as brand,br.brandname from Brand as br left join ProductMaster as pm on pm.brand=br.id left join SubcategoryL1  as sub1 on sub1.scl1_id=pm.scl1_id left join Category as ca on ca.catid=sub1.catid where ca.catid='"+get_collection[0].classification_id+"' "+query1+"";
  }else if(get_collection[0].classification_type==3){
    var brand_list_query = "select br.id as brand,br.brandname from Brand as br left join ProductMaster as pm on pm.brand=br.id left join SubcategoryL1  as sub1 on sub1.scl1_id=pm.scl1_id where sub1.scl1_id='"+get_collection[0].classification_id+"' "+query1+" ";
  }else if(get_collection[0].classification_type==4){
    var brand_list_query = "select br.id as brand,br.brandname from Brand as br left join ProductMaster as pm on pm.brand=br.id left join SubcategoryL2  as sub2 on sub2.scl2_id=pm.scl2_id where sub2.scl2_id='"+get_collection[0].classification_id+"' "+query1+"";
  }else if(get_collection[0].classification_type==5){
    var brand_list_query = "select br.id as brand,br.brandname from Collection_mapping_product cmp left join Product_live pl on pl.pid=cmp.pid left join ProductMaster as pm on pm.pid=pl.pid  left join Brand br on pm.brand=br.id  where cmp.cid='"+get_collection[0].cid+"'  and pl.live_status=1 and cmp.active_status=1 "+query1+"";
  }else if(get_collection[0].classification_type==6){
    var brand_list_query = "select br.id as brand,br.brandname from Brand as br left join ProductMaster as pm on pm.brand=br.id left join SubcategoryL2  as sub2 on sub2.scl2_id=pm.scl2_id where pm.mrp BETWEEN  '"+get_collection[0].start_price+"' and '"+get_collection[0].end_price+"'  "+query1+"";
  }
