...
var MoveitUser = function(moveituser) {
    ...
    this.verified_status = moveituser.verified_status || 0;
    this.online_status = moveituser.online_status || 0; ///////no used
    ...
    this.login_status = moveituser.login_status || 0; ///////no used
