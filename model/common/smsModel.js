...
SMS.ordersuccess_send_sms =async function ordersuccess_send_sms(orderid,phoneno, result){
  ...
  // }else{
    otpurl = "https://www.instaalerts.zone/SendSMS/sendmsg.php?uname=EATotp1&pass=abc321&send=CHOICB&dest==" +phoneno+ "&msg=Your transaction with id "+orderid+" has been successfully placed with Daily Locally. \n Due to the prevailing pandemic, we are facing brief delays in deliveries. However, for any queries about your order, please get in touch through! ";    
  //  }
